...
export default {
  ...
  methods: {
    ...
    editItem(item) {
      this.editedIndex = this.filiais.indexOf(item);
      this.editedItem = Object.assign({}, item);
      this.dialog = true;
    },

    deleteItem(item) {
      const index = this.filiais.indexOf(item);
    ...
    save() {
      if (this.editedIndex > -1) {
        Object.assign(this.filiais[this.editedIndex], this.editedItem);
      } else {
        this.filiais.push(this.editedItem);
      }
      this.close();
    },
  },
