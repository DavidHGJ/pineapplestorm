...
abstract class MapTabelas{
    ...
    protected function __construct(){
        ...
        $this-> adicionarTabelas(
            ...
            new Tabela('ENTRADA', 'ENT_ID', 'TRS_ID', 'ENT_DATA', 'CONTA_QTDE_ITEMS_ENTRADA(ENT_ID) AS ENT_QTDE', 'VALOR_TOTAL_ITEMS_ENTRADA(ENT_ID) AS ENT_VALOR', 'ENT_FRETE', 'ENT_IMPOSTO', 'USR_ID', 'NF_ID'),
